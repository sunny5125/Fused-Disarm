...
public class LocationUpdateService extends Service implements
    ...
    Double firstTimeCheckLat,firstTimeCheckLong ,secondTimeCheckLat,secondTimeCheckLong,calculatedDistance,garbage,calculatedBearing;
    ...
    private Runnable LocationListenerToggler = new Runnable() {
        ...
        public void run() {
            if (!mRequestingLocationUpdates) {
                ...
                Log.i(TAG, " startLocationUpdates by RUnnable");
                isEnded = true;
                a = true;
            }
